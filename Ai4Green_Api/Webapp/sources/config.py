...
class BaseConfig(object):  # class to store configuration variables
    ...
    CONDITIONS_API_KEY = os.getenv("CONDITIONS_API_KEY", "retro_key")
    RETROSYNTHESIS_API_URL = os.getenv(
        "RETROSYNTHESIS_API_URL", "http://localhost:4000"
    )
    # RETROSYNTHESIS_API_URL = os.getenv(
    #     "RETROSYNTHESIS_API_URL", "http://192.168.0.24:5000"
    # )
    CONDITIONS_API_URL = os.getenv("CONDITIONS_API_URL", "http://localhost:9000")
